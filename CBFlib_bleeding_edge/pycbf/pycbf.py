...
class doubleArray(_object):
    ...
    def __init__(self, nelements):
        this = _pycbf.new_doubleArray(nelements)
        try:
    ...
    if _newclass:
        frompointer = staticmethod(_pycbf.doubleArray_frompointer)
...
class intArray(_object):
    ...
    def __init__(self, nelements):
        this = _pycbf.new_intArray(nelements)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    if _newclass:
        frompointer = staticmethod(_pycbf.intArray_frompointer)
...
class shortArray(_object):
    ...
    def __init__(self, nelements):
        this = _pycbf.new_shortArray(nelements)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    if _newclass:
        frompointer = staticmethod(_pycbf.shortArray_frompointer)
...
class longArray(_object):
    ...
    def __init__(self, nelements):
        this = _pycbf.new_longArray(nelements)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    if _newclass:
        frompointer = staticmethod(_pycbf.longArray_frompointer)
...
_pycbf.CBF_INTEGER_swigconstant(_pycbf)
CBF_INTEGER = _pycbf.CBF_INTEGER

_pycbf.CBF_FLOAT_swigconstant(_pycbf)
CBF_FLOAT = _pycbf.CBF_FLOAT

_pycbf.CBF_CANONICAL_swigconstant(_pycbf)
CBF_CANONICAL = _pycbf.CBF_CANONICAL

_pycbf.CBF_PACKED_swigconstant(_pycbf)
CBF_PACKED = _pycbf.CBF_PACKED

_pycbf.CBF_PACKED_V2_swigconstant(_pycbf)
CBF_PACKED_V2 = _pycbf.CBF_PACKED_V2

_pycbf.CBF_BYTE_OFFSET_swigconstant(_pycbf)
CBF_BYTE_OFFSET = _pycbf.CBF_BYTE_OFFSET

_pycbf.CBF_PREDICTOR_swigconstant(_pycbf)
CBF_PREDICTOR = _pycbf.CBF_PREDICTOR

_pycbf.CBF_NONE_swigconstant(_pycbf)
CBF_NONE = _pycbf.CBF_NONE

_pycbf.CBF_COMPRESSION_MASK_swigconstant(_pycbf)
CBF_COMPRESSION_MASK = _pycbf.CBF_COMPRESSION_MASK

_pycbf.CBF_FLAG_MASK_swigconstant(_pycbf)
CBF_FLAG_MASK = _pycbf.CBF_FLAG_MASK

_pycbf.CBF_UNCORRELATED_SECTIONS_swigconstant(_pycbf)
CBF_UNCORRELATED_SECTIONS = _pycbf.CBF_UNCORRELATED_SECTIONS

_pycbf.CBF_FLAT_IMAGE_swigconstant(_pycbf)
CBF_FLAT_IMAGE = _pycbf.CBF_FLAT_IMAGE

_pycbf.CBF_NO_EXPAND_swigconstant(_pycbf)
CBF_NO_EXPAND = _pycbf.CBF_NO_EXPAND

_pycbf.PLAIN_HEADERS_swigconstant(_pycbf)
PLAIN_HEADERS = _pycbf.PLAIN_HEADERS

_pycbf.MIME_HEADERS_swigconstant(_pycbf)
MIME_HEADERS = _pycbf.MIME_HEADERS

_pycbf.MSG_NODIGEST_swigconstant(_pycbf)
MSG_NODIGEST = _pycbf.MSG_NODIGEST

_pycbf.MSG_DIGEST_swigconstant(_pycbf)
MSG_DIGEST = _pycbf.MSG_DIGEST

_pycbf.MSG_DIGESTNOW_swigconstant(_pycbf)
MSG_DIGESTNOW = _pycbf.MSG_DIGESTNOW

_pycbf.MSG_DIGESTWARN_swigconstant(_pycbf)
MSG_DIGESTWARN = _pycbf.MSG_DIGESTWARN

_pycbf.PAD_1K_swigconstant(_pycbf)
PAD_1K = _pycbf.PAD_1K

_pycbf.PAD_2K_swigconstant(_pycbf)
PAD_2K = _pycbf.PAD_2K

_pycbf.PAD_4K_swigconstant(_pycbf)
PAD_4K = _pycbf.PAD_4K

_pycbf.CBF_PARSE_BRC_swigconstant(_pycbf)
CBF_PARSE_BRC = _pycbf.CBF_PARSE_BRC

_pycbf.CBF_PARSE_PRN_swigconstant(_pycbf)
CBF_PARSE_PRN = _pycbf.CBF_PARSE_PRN

_pycbf.CBF_PARSE_BKT_swigconstant(_pycbf)
CBF_PARSE_BKT = _pycbf.CBF_PARSE_BKT

_pycbf.CBF_PARSE_BRACKETS_swigconstant(_pycbf)
CBF_PARSE_BRACKETS = _pycbf.CBF_PARSE_BRACKETS

_pycbf.CBF_PARSE_TQ_swigconstant(_pycbf)
CBF_PARSE_TQ = _pycbf.CBF_PARSE_TQ

_pycbf.CBF_PARSE_CIF2_DELIMS_swigconstant(_pycbf)
CBF_PARSE_CIF2_DELIMS = _pycbf.CBF_PARSE_CIF2_DELIMS

_pycbf.CBF_PARSE_DDLm_swigconstant(_pycbf)
CBF_PARSE_DDLm = _pycbf.CBF_PARSE_DDLm

_pycbf.CBF_PARSE_CIF2_swigconstant(_pycbf)
CBF_PARSE_CIF2 = _pycbf.CBF_PARSE_CIF2

_pycbf.CBF_PARSE_DEFINES_swigconstant(_pycbf)
CBF_PARSE_DEFINES = _pycbf.CBF_PARSE_DEFINES

_pycbf.CBF_PARSE_WIDE_swigconstant(_pycbf)
CBF_PARSE_WIDE = _pycbf.CBF_PARSE_WIDE

_pycbf.CBF_PARSE_UTF8_swigconstant(_pycbf)
CBF_PARSE_UTF8 = _pycbf.CBF_PARSE_UTF8

_pycbf.HDR_DEFAULT_swigconstant(_pycbf)
HDR_DEFAULT = _pycbf.HDR_DEFAULT

_pycbf.MIME_NOHEADERS_swigconstant(_pycbf)
MIME_NOHEADERS = _pycbf.MIME_NOHEADERS

_pycbf.CBF_swigconstant(_pycbf)
CBF = _pycbf.CBF

_pycbf.CIF_swigconstant(_pycbf)
CIF = _pycbf.CIF

_pycbf.ENC_NONE_swigconstant(_pycbf)
ENC_NONE = _pycbf.ENC_NONE

_pycbf.ENC_BASE64_swigconstant(_pycbf)
ENC_BASE64 = _pycbf.ENC_BASE64

_pycbf.ENC_BASE32K_swigconstant(_pycbf)
ENC_BASE32K = _pycbf.ENC_BASE32K

_pycbf.ENC_QP_swigconstant(_pycbf)
ENC_QP = _pycbf.ENC_QP

_pycbf.ENC_BASE10_swigconstant(_pycbf)
ENC_BASE10 = _pycbf.ENC_BASE10

_pycbf.ENC_BASE16_swigconstant(_pycbf)
ENC_BASE16 = _pycbf.ENC_BASE16

_pycbf.ENC_BASE8_swigconstant(_pycbf)
ENC_BASE8 = _pycbf.ENC_BASE8

_pycbf.ENC_FORWARD_swigconstant(_pycbf)
ENC_FORWARD = _pycbf.ENC_FORWARD

_pycbf.ENC_BACKWARD_swigconstant(_pycbf)
ENC_BACKWARD = _pycbf.ENC_BACKWARD

_pycbf.ENC_CRTERM_swigconstant(_pycbf)
ENC_CRTERM = _pycbf.ENC_CRTERM

_pycbf.ENC_LFTERM_swigconstant(_pycbf)
ENC_LFTERM = _pycbf.ENC_LFTERM

_pycbf.ENC_DEFAULT_swigconstant(_pycbf)
...
class cbf_positioner_struct(_object):
    ...
    if _newclass:
        matrix = _swig_property(_pycbf.cbf_positioner_struct_matrix_get, _pycbf.cbf_positioner_struct_matrix_set)
    ...
    if _newclass:
        axis = _swig_property(_pycbf.cbf_positioner_struct_axis_get, _pycbf.cbf_positioner_struct_axis_set)
    ...
    if _newclass:
        axes = _swig_property(_pycbf.cbf_positioner_struct_axes_get, _pycbf.cbf_positioner_struct_axes_set)
    ...
    if _newclass:
        matrix_is_valid = _swig_property(_pycbf.cbf_positioner_struct_matrix_is_valid_get, _pycbf.cbf_positioner_struct_matrix_is_valid_set)
    __swig_setmethods__["matrix_ratio_used"] = _pycbf.cbf_positioner_struct_matrix_ratio_used_set
    __swig_getmethods__["matrix_ratio_used"] = _pycbf.cbf_positioner_struct_matrix_ratio_used_get
    if _newclass:
        matrix_ratio_used = _swig_property(_pycbf.cbf_positioner_struct_matrix_ratio_used_get, _pycbf.cbf_positioner_struct_matrix_ratio_used_set)
    __swig_setmethods__["axis_index_limit"] = _pycbf.cbf_positioner_struct_axis_index_limit_set
    __swig_getmethods__["axis_index_limit"] = _pycbf.cbf_positioner_struct_axis_index_limit_get
    if _newclass:
        axis_index_limit = _swig_property(_pycbf.cbf_positioner_struct_axis_index_limit_get, _pycbf.cbf_positioner_struct_axis_index_limit_set)

    def __init__(self):
        """__init__(cbf_positioner_struct self) -> cbf_positioner_struct"""
...
class cbf_detector_struct(_object):
    ...
    if _newclass:
        positioner = _swig_property(_pycbf.cbf_detector_struct_positioner_get, _pycbf.cbf_detector_struct_positioner_set)
    ...
    if _newclass:
        displacement = _swig_property(_pycbf.cbf_detector_struct_displacement_get, _pycbf.cbf_detector_struct_displacement_set)
    ...
    if _newclass:
        increment = _swig_property(_pycbf.cbf_detector_struct_increment_get, _pycbf.cbf_detector_struct_increment_set)
    __swig_setmethods__["axes"] = _pycbf.cbf_detector_struct_axes_set
    __swig_getmethods__["axes"] = _pycbf.cbf_detector_struct_axes_get
    if _newclass:
        axes = _swig_property(_pycbf.cbf_detector_struct_axes_get, _pycbf.cbf_detector_struct_axes_set)
    ...
    if _newclass:
        index = _swig_property(_pycbf.cbf_detector_struct_index_get, _pycbf.cbf_detector_struct_index_set)

    def __init__(self):
        """__init__(cbf_detector_struct self) -> cbf_detector_struct"""
    ...
    def set_beam_center_fs(self, indexfast, indexslow, centerfast, centerslow):
        ...
        *centerfast and *indexfast are the fast axis components of the center 
        ...
        """
        return _pycbf.cbf_detector_struct_set_beam_center_fs(self, indexfast, indexslow, centerfast, centerslow)
    ...
    def set_reference_beam_center_fs(self, indexfast, indexslow, centerfast, centerslow):
        ...
        *centerfast and *indexfast are the fast axis components of the center 
        ...
        """
        return _pycbf.cbf_detector_struct_set_reference_beam_center_fs(self, indexfast, indexslow, centerfast, centerslow)
    ...
    def set_reference_beam_center(self, indexslow, indexfast, centerslow, centerfast):
        ...
        *centerfast and *indexfast are the fast axis components of the center 
        ...
        """
        return _pycbf.cbf_detector_struct_set_reference_beam_center(self, indexslow, indexfast, centerslow, centerfast)
    ...
    def get_detector_axes_fs(self):
        """get_detector_axes_fs(cbf_detector_struct self)"""
    ...
    def set_beam_center(self, indexslow, indexfast, centerslow, centerfast):
        ...
        *centerfast and *indexfast are the fast axis components of the center 
        ...
        """
        return _pycbf.cbf_detector_struct_set_beam_center(self, indexslow, indexfast, centerslow, centerfast)
...
_pycbf.CBF_UNDEFNODE_swigconstant(_pycbf)
CBF_UNDEFNODE = _pycbf.CBF_UNDEFNODE

_pycbf.CBF_LINK_swigconstant(_pycbf)
CBF_LINK = _pycbf.CBF_LINK

_pycbf.CBF_ROOT_swigconstant(_pycbf)
CBF_ROOT = _pycbf.CBF_ROOT

_pycbf.CBF_DATABLOCK_swigconstant(_pycbf)
CBF_DATABLOCK = _pycbf.CBF_DATABLOCK

_pycbf.CBF_SAVEFRAME_swigconstant(_pycbf)
CBF_SAVEFRAME = _pycbf.CBF_SAVEFRAME

_pycbf.CBF_CATEGORY_swigconstant(_pycbf)
CBF_CATEGORY = _pycbf.CBF_CATEGORY

_pycbf.CBF_COLUMN_swigconstant(_pycbf)
...
class cbf_handle_struct(_object):
    ...
    if _newclass:
        node = _swig_property(_pycbf.cbf_handle_struct_node_get, _pycbf.cbf_handle_struct_node_set)
    __swig_setmethods__["row"] = _pycbf.cbf_handle_struct_row_set
    __swig_getmethods__["row"] = _pycbf.cbf_handle_struct_row_get
    if _newclass:
        row = _swig_property(_pycbf.cbf_handle_struct_row_get, _pycbf.cbf_handle_struct_row_set)
    ...
    if _newclass:
        search_row = _swig_property(_pycbf.cbf_handle_struct_search_row_get, _pycbf.cbf_handle_struct_search_row_set)

    def __init__(self):
        """__init__(cbf_handle_struct self) -> cbf_handle_struct"""
    ...
    def get_element_number(self):
        """get_element_number(cbf_handle_struct self)"""
    ...
    def get_reciprocal_cell_esd(self):
        """get_reciprocal_cell_esd(cbf_handle_struct self)"""
    ...
    def require_category_root(self, categoryname):
        """require_category_root(cbf_handle_struct self, char const * categoryname) -> char const *"""
    ...
    def get_3d_image_size_fs(self, element_number):
        """get_3d_image_size_fs(cbf_handle_struct self, unsigned int element_number)"""
