...
int main (int argc, char *argv [])
{
  ...
  if (!(in = fopen ("testflatpackedin.cbf", "rb"))) {
    ...
    if (compression != CBF_PACKED) fprintf(stderr, "testflat: Compression %x instead of CBF_PACKED\n", compression);
...
/*  Create an  array 1000 x 1000 ints in a flat field of 1000 */
  ...
  cbf_failnez (cbf_set_integerarray_wdims (cbf, CBF_PACKED, 1,
                               image, sizeof (int), 0,
  ...
  cbf_failnez (cbf_set_integerarray_wdims (cbf, CBF_PACKED, 2,
                               shimage, sizeof (short), 0,
                               1000000, "little_endian",1000,1000,0,4095))
 ...
 /*  Create an  array 1000 x 1000 signed ints in a flat field of 1000, except for
  ...
  cbf_failnez (cbf_set_integerarray_wdims (cbf, CBF_PACKED, 3,
                               image, sizeof (int), 1,
                               1000000,"little_endian",1000,1000,0,4095))
 ...
 /*  Create an array 1000 x 1000 shorts in a flat field of 1000, except for
  ...
  cbf_failnez (cbf_set_integerarray_wdims (cbf, CBF_PACKED, 4,
                               shimage, sizeof (short), 1,
                               1000000, "little_endian",1000,1000,0,4095))
 ...
 /*  Create an  array 50 x 60 x 70 signed ints in a flat field of 1000, except for
  ...
  out = fopen ("testflatpackedout.cbf", "w+b");
