...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_pycbf')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_pycbf')
...
class doubleArray(_object):
    ...
    if _newclass:
        ...
        frompointer = _pycbf.doubleArray_frompointer
...
class intArray(_object):
    ...
    if _newclass:
        ...
        frompointer = _pycbf.intArray_frompointer
...
class shortArray(_object):
    ...
    if _newclass:
        ...
        frompointer = _pycbf.shortArray_frompointer
...
class longArray(_object):
    ...
    if _newclass:
        ...
        frompointer = _pycbf.longArray_frompointer
...
def compute_cell_volume(cell):
    ...
    *args   : double cell[6]
    ...
    cell[3:5] for the cell angles alpha, beta and gamma in degrees.
    ARGUMENTS
