...
SWIGINTERN char const *cbf_handle_struct_get_value(cbf_handle_struct *self){
    ...
    return result;}
SWIGINTERN void cbf_handle_struct_set_reciprocal_cell(cbf_handle_struct *self){
        {(error_status = CBF_NOTIMPLEMENTED);};}
...
SWIGINTERN char const *cbf_handle_struct_datablock_name(cbf_handle_struct *self){
    ...
    return result;}
SWIGINTERN void cbf_handle_struct_set_realarray_wdims(cbf_handle_struct *self){
        {(error_status = CBF_NOTIMPLEMENTED);};}
...
SWIGINTERN unsigned int cbf_handle_struct_count_columns(cbf_handle_struct *self){
      ...
      return result;}
SWIGINTERN void cbf_handle_struct_get_integerarrayparameters_wdims(cbf_handle_struct *self){
        {(error_status = CBF_NOTIMPLEMENTED);};}
...
SWIGINTERN void cbf_handle_struct_set_real_3d_image(cbf_handle_struct *self){
        {(error_status = CBF_NOTIMPLEMENTED);};}
...
SWIGINTERN void cbf_handle_struct_get_realarray(cbf_handle_struct *self){
        {(error_status = CBF_NOTIMPLEMENTED);};}
SWIGINTERN void cbf_handle_struct_get_bin_sizes(cbf_handle_struct *self){
        {(error_status = CBF_NOTIMPLEMENTED);};}
...
SWIGINTERN void cbf_handle_struct_set_3d_image(cbf_handle_struct *self){
        {(error_status = CBF_NOTIMPLEMENTED);};}
...
SWIGINTERN void cbf_handle_struct_set_integerarray_wdims(cbf_handle_struct *self){
        {(error_status = CBF_NOTIMPLEMENTED);};}
...
SWIGINTERN void cbf_handle_struct_get_real_image(cbf_handle_struct *self){
        {(error_status = CBF_NOTIMPLEMENTED);};}
...
SWIGINTERN void cbf_handle_struct_get_realarrayparameters_wdims(cbf_handle_struct *self){
        {(error_status = CBF_NOTIMPLEMENTED);};}
...
SWIGINTERN char const *cbf_handle_struct_get_typeofvalue(cbf_handle_struct *self){
    ...
    return result;}
SWIGINTERN void cbf_handle_struct_set_real_image(cbf_handle_struct *self){
        {(error_status = CBF_NOTIMPLEMENTED);};}
SWIGINTERN void cbf_handle_struct_get_3d_image(cbf_handle_struct *self){
        {(error_status = CBF_NOTIMPLEMENTED);};}
...
SWIGINTERN void cbf_handle_struct_get_image_size(cbf_handle_struct *self,unsigned int element_number,int *ndim1,int *ndim2){
        unsigned int reserved;
        size_t in1, in2;
        reserved = 0;
        {(error_status = cbf_get_image_size(self,reserved,element_number,&in1,&in2));};
        *ndim1 = in1; /* FIXME - is that how to convert? */
        *ndim2 = in2; 
        }
SWIGINTERN void cbf_handle_struct_get_image(cbf_handle_struct *self){
        {(error_status = CBF_NOTIMPLEMENTED);};}
...
SWIGINTERN void cbf_handle_struct_get_real_3d_image(cbf_handle_struct *self){
        {(error_status = CBF_NOTIMPLEMENTED);};}
SWIGINTERN void cbf_handle_struct_get_integration_time(cbf_handle_struct *self,double *time){
        unsigned int reserved;
        reserved = 0;
        {(error_status = cbf_get_integration_time(self,reserved,time));};
        }
SWIGINTERN void cbf_handle_struct_set_realarray(cbf_handle_struct *self){
        {(error_status = CBF_NOTIMPLEMENTED);};}
...
SWIGINTERN PyObject *_wrap_cbf_detector_struct_displacement_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "cbf_detector_struct_displacement_set" "', argument " "2"" of type '" "double [2]""'"); 
  } 
  arg2 = (double *)(argp2);
  {
    if (arg2) {
...
SWIGINTERN PyObject *_wrap_cbf_detector_struct_increment_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res2 = SWIG_ConvertPtr(obj1, &argp2,SWIGTYPE_p_double, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "cbf_detector_struct_increment_set" "', argument " "2"" of type '" "double [2]""'"); 
  } 
  arg2 = (double *)(argp2);
  {
    if (arg2) {
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_set_image(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cbf_handle_struct_set_image",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cbf_handle_struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  {
    error_status=0;
    cbf_handle_struct_set_image(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_set_reciprocal_cell(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cbf_handle_struct_set_reciprocal_cell",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cbf_handle_struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  {
    error_status=0;
    cbf_handle_struct_set_reciprocal_cell(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_set_realarray_wdims(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cbf_handle_struct_set_realarray_wdims",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cbf_handle_struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  {
    error_status=0;
    cbf_handle_struct_set_realarray_wdims(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_get_integerarrayparameters_wdims(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    error_status=0;
    cbf_handle_struct_get_integerarrayparameters_wdims(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_set_real_3d_image(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cbf_handle_struct_set_real_3d_image",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cbf_handle_struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  {
    error_status=0;
    cbf_handle_struct_set_real_3d_image(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_get_realarray(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  cbf_handle_struct *arg1 = (cbf_handle_struct *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cbf_handle_struct_get_realarray",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cbf_handle_struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "cbf_handle_struct_get_realarray" "', argument " "1"" of type '" "cbf_handle_struct *""'"); 
  }
  arg1 = (cbf_handle_struct *)(argp1);
  {
    error_status=0;
    cbf_handle_struct_get_realarray(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_get_bin_sizes(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cbf_handle_struct_get_bin_sizes",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cbf_handle_struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  {
    error_status=0;
    cbf_handle_struct_get_bin_sizes(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_set_3d_image(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cbf_handle_struct_set_3d_image",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cbf_handle_struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  {
    error_status=0;
    cbf_handle_struct_set_3d_image(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_set_integerarray_wdims(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cbf_handle_struct_set_integerarray_wdims",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cbf_handle_struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  {
    error_status=0;
    cbf_handle_struct_set_integerarray_wdims(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_get_real_image(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  cbf_handle_struct *arg1 = (cbf_handle_struct *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cbf_handle_struct_get_real_image",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cbf_handle_struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "cbf_handle_struct_get_real_image" "', argument " "1"" of type '" "cbf_handle_struct *""'"); 
  }
  arg1 = (cbf_handle_struct *)(argp1);
  {
    error_status=0;
    cbf_handle_struct_get_real_image(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_get_realarrayparameters_wdims(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    error_status=0;
    cbf_handle_struct_get_realarrayparameters_wdims(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_get_reciprocal_cell(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    error_status=0;
    cbf_handle_struct_get_reciprocal_cell(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_set_real_image(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cbf_handle_struct_set_real_image",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cbf_handle_struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  {
    error_status=0;
    cbf_handle_struct_set_real_image(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_get_3d_image(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  cbf_handle_struct *arg1 = (cbf_handle_struct *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cbf_handle_struct_get_3d_image",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cbf_handle_struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "cbf_handle_struct_get_3d_image" "', argument " "1"" of type '" "cbf_handle_struct *""'"); 
  }
  arg1 = (cbf_handle_struct *)(argp1);
  {
    error_status=0;
    cbf_handle_struct_get_3d_image(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_get_image(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  cbf_handle_struct *arg1 = (cbf_handle_struct *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cbf_handle_struct_get_image",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cbf_handle_struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "cbf_handle_struct_get_image" "', argument " "1"" of type '" "cbf_handle_struct *""'"); 
  }
  arg1 = (cbf_handle_struct *)(argp1);
  {
    error_status=0;
    cbf_handle_struct_get_image(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_get_real_3d_image(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  cbf_handle_struct *arg1 = (cbf_handle_struct *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cbf_handle_struct_get_real_3d_image",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cbf_handle_struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "cbf_handle_struct_get_real_3d_image" "', argument " "1"" of type '" "cbf_handle_struct *""'"); 
  }
  arg1 = (cbf_handle_struct *)(argp1);
  {
    error_status=0;
    cbf_handle_struct_get_real_3d_image(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
SWIGINTERN PyObject *_wrap_cbf_handle_struct_set_realarray(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cbf_handle_struct_set_realarray",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cbf_handle_struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  {
    error_status=0;
    cbf_handle_struct_set_realarray(arg1);
    if (error_status){
      get_error_message();
      PyErr_SetString(PyExc_Exception,error_message);
      return NULL;
...
static PyMethodDef SwigMethods[] = {
	 { (char *)"get_local_integer_byte_order", _wrap_get_local_integer_byte_order, METH_VARARGS, NULL},
	 { (char *)"get_local_real_format", _wrap_get_local_real_format, METH_VARARGS, NULL},
	 { (char *)"get_local_real_byte_order", _wrap_get_local_real_byte_order, METH_VARARGS, NULL},
	 ...
	 { (char *)"new_cbf_positioner_struct", _wrap_new_cbf_positioner_struct, METH_VARARGS, NULL},
	 { (char *)"delete_cbf_positioner_struct", _wrap_delete_cbf_positioner_struct, METH_VARARGS, NULL},
	 { (char *)"cbf_positioner_struct_get_rotation_range", _wrap_cbf_positioner_struct_get_rotation_range, METH_VARARGS, NULL},
	 { (char *)"cbf_positioner_struct_rotate_vector", _wrap_cbf_positioner_struct_rotate_vector, METH_VARARGS, NULL},
	 { (char *)"cbf_positioner_struct_get_reciprocal", _wrap_cbf_positioner_struct_get_reciprocal, METH_VARARGS, NULL},
	 { (char *)"cbf_positioner_struct_get_rotation_axis", _wrap_cbf_positioner_struct_get_rotation_axis, METH_VARARGS, NULL},
	 { (char *)"cbf_positioner_struct_swigregister", cbf_positioner_struct_swigregister, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_positioner_set", _wrap_cbf_detector_struct_positioner_set, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_positioner_get", _wrap_cbf_detector_struct_positioner_get, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_displacement_set", _wrap_cbf_detector_struct_displacement_set, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_displacement_get", _wrap_cbf_detector_struct_displacement_get, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_increment_set", _wrap_cbf_detector_struct_increment_set, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_increment_get", _wrap_cbf_detector_struct_increment_get, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_axes_set", _wrap_cbf_detector_struct_axes_set, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_axes_get", _wrap_cbf_detector_struct_axes_get, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_index_set", _wrap_cbf_detector_struct_index_set, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_index_get", _wrap_cbf_detector_struct_index_get, METH_VARARGS, NULL},
	 { (char *)"new_cbf_detector_struct", _wrap_new_cbf_detector_struct, METH_VARARGS, NULL},
	 { (char *)"delete_cbf_detector_struct", _wrap_delete_cbf_detector_struct, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_get_pixel_normal", _wrap_cbf_detector_struct_get_pixel_normal, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_get_pixel_area", _wrap_cbf_detector_struct_get_pixel_area, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_get_detector_distance", _wrap_cbf_detector_struct_get_detector_distance, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_get_detector_normal", _wrap_cbf_detector_struct_get_detector_normal, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_get_inferred_pixel_size", _wrap_cbf_detector_struct_get_inferred_pixel_size, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_get_pixel_coordinates", _wrap_cbf_detector_struct_get_pixel_coordinates, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_get_beam_center", _wrap_cbf_detector_struct_get_beam_center, METH_VARARGS, NULL},
	 { (char *)"cbf_detector_struct_swigregister", cbf_detector_struct_swigregister, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_node_set", _wrap_cbf_handle_struct_node_set, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_node_get", _wrap_cbf_handle_struct_node_get, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_row_set", _wrap_cbf_handle_struct_row_set, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_row_get", _wrap_cbf_handle_struct_row_get, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_search_row_set", _wrap_cbf_handle_struct_search_row_set, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_search_row_get", _wrap_cbf_handle_struct_search_row_get, METH_VARARGS, NULL},
	 { (char *)"new_cbf_handle_struct", _wrap_new_cbf_handle_struct, METH_VARARGS, NULL},
	 { (char *)"delete_cbf_handle_struct", _wrap_delete_cbf_handle_struct, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_select_datablock", _wrap_cbf_handle_struct_select_datablock, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_force_new_datablock", _wrap_cbf_handle_struct_force_new_datablock, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_reset_datablocks", _wrap_cbf_handle_struct_reset_datablocks, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_tag_category", _wrap_cbf_handle_struct_set_tag_category, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_row_number", _wrap_cbf_handle_struct_row_number, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_image", _wrap_cbf_handle_struct_set_image, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_bin_sizes", _wrap_cbf_handle_struct_set_bin_sizes, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_new_row", _wrap_cbf_handle_struct_new_row, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_rewind_saveframe", _wrap_cbf_handle_struct_rewind_saveframe, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_realarrayparameters", _wrap_cbf_handle_struct_get_realarrayparameters, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_force_new_category", _wrap_cbf_handle_struct_force_new_category, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_force_new_saveframe", _wrap_cbf_handle_struct_force_new_saveframe, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_count_datablocks", _wrap_cbf_handle_struct_count_datablocks, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_find_row", _wrap_cbf_handle_struct_find_row, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_select_column", _wrap_cbf_handle_struct_select_column, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_construct_detector", _wrap_cbf_handle_struct_construct_detector, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_rewind_column", _wrap_cbf_handle_struct_rewind_column, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_require_column_doublevalue", _wrap_cbf_handle_struct_require_column_doublevalue, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_datestamp", _wrap_cbf_handle_struct_get_datestamp, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_integervalue", _wrap_cbf_handle_struct_get_integervalue, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_crystal_id", _wrap_cbf_handle_struct_get_crystal_id, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_doublevalue", _wrap_cbf_handle_struct_get_doublevalue, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_unit_cell", _wrap_cbf_handle_struct_get_unit_cell, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_remove_column", _wrap_cbf_handle_struct_remove_column, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_rewind_blockitem", _wrap_cbf_handle_struct_rewind_blockitem, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_value", _wrap_cbf_handle_struct_get_value, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_reciprocal_cell", _wrap_cbf_handle_struct_set_reciprocal_cell, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_count_categories", _wrap_cbf_handle_struct_count_categories, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_read_widefile", _wrap_cbf_handle_struct_read_widefile, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_wavelength", _wrap_cbf_handle_struct_set_wavelength, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_diffrn_id", _wrap_cbf_handle_struct_get_diffrn_id, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_dictionary", _wrap_cbf_handle_struct_get_dictionary, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_polarization", _wrap_cbf_handle_struct_get_polarization, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_select_category", _wrap_cbf_handle_struct_select_category, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_read_file", _wrap_cbf_handle_struct_read_file, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_datablock_name", _wrap_cbf_handle_struct_datablock_name, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_realarray_wdims", _wrap_cbf_handle_struct_set_realarray_wdims, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_rewind_row", _wrap_cbf_handle_struct_rewind_row, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_axis_setting", _wrap_cbf_handle_struct_get_axis_setting, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_require_column", _wrap_cbf_handle_struct_require_column, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_timestamp", _wrap_cbf_handle_struct_get_timestamp, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_find_nextrow", _wrap_cbf_handle_struct_find_nextrow, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_require_tag_root", _wrap_cbf_handle_struct_require_tag_root, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_reset_datablock", _wrap_cbf_handle_struct_reset_datablock, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_require_integervalue", _wrap_cbf_handle_struct_require_integervalue, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_integerarrayparameters", _wrap_cbf_handle_struct_get_integerarrayparameters, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_write_file", _wrap_cbf_handle_struct_write_file, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_divergence", _wrap_cbf_handle_struct_set_divergence, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_remove_datablock", _wrap_cbf_handle_struct_remove_datablock, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_count_elements", _wrap_cbf_handle_struct_count_elements, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_pixel_size", _wrap_cbf_handle_struct_get_pixel_size, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_next_category", _wrap_cbf_handle_struct_next_category, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_diffrn_id", _wrap_cbf_handle_struct_set_diffrn_id, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_timestamp", _wrap_cbf_handle_struct_set_timestamp, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_orientation_matrix", _wrap_cbf_handle_struct_get_orientation_matrix, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_divergence", _wrap_cbf_handle_struct_get_divergence, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_rewind_category", _wrap_cbf_handle_struct_rewind_category, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_read_template", _wrap_cbf_handle_struct_read_template, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_select_row", _wrap_cbf_handle_struct_select_row, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_count_columns", _wrap_cbf_handle_struct_count_columns, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_integerarrayparameters_wdims", _wrap_cbf_handle_struct_get_integerarrayparameters_wdims, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_gain", _wrap_cbf_handle_struct_get_gain, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_new_saveframe", _wrap_cbf_handle_struct_new_saveframe, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_polarization", _wrap_cbf_handle_struct_set_polarization, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_real_3d_image", _wrap_cbf_handle_struct_set_real_3d_image, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_delete_row", _wrap_cbf_handle_struct_delete_row, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_column_name", _wrap_cbf_handle_struct_column_name, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_remove_saveframe", _wrap_cbf_handle_struct_remove_saveframe, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_require_value", _wrap_cbf_handle_struct_require_value, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_require_column_integervalue", _wrap_cbf_handle_struct_require_column_integervalue, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_pixel_size", _wrap_cbf_handle_struct_set_pixel_size, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_next_column", _wrap_cbf_handle_struct_next_column, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_realarray", _wrap_cbf_handle_struct_get_realarray, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_bin_sizes", _wrap_cbf_handle_struct_get_bin_sizes, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_reset_category", _wrap_cbf_handle_struct_reset_category, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_construct_goniometer", _wrap_cbf_handle_struct_construct_goniometer, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_datablockname", _wrap_cbf_handle_struct_set_datablockname, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_crystal_id", _wrap_cbf_handle_struct_set_crystal_id, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_integerarray_as_string", _wrap_cbf_handle_struct_get_integerarray_as_string, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_3d_image", _wrap_cbf_handle_struct_set_3d_image, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_dictionary", _wrap_cbf_handle_struct_set_dictionary, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_find_tag_category", _wrap_cbf_handle_struct_find_tag_category, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_typeofvalue", _wrap_cbf_handle_struct_set_typeofvalue, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_integerarray_wdims", _wrap_cbf_handle_struct_set_integerarray_wdims, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_integration_time", _wrap_cbf_handle_struct_set_integration_time, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_axis_setting", _wrap_cbf_handle_struct_set_axis_setting, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_real_image", _wrap_cbf_handle_struct_get_real_image, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_overload", _wrap_cbf_handle_struct_get_overload, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_wavelength", _wrap_cbf_handle_struct_get_wavelength, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_next_datablock", _wrap_cbf_handle_struct_next_datablock, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_realarrayparameters_wdims", _wrap_cbf_handle_struct_get_realarrayparameters_wdims, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_orientation_matrix", _wrap_cbf_handle_struct_set_orientation_matrix, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_new_category", _wrap_cbf_handle_struct_new_category, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_gain", _wrap_cbf_handle_struct_set_gain, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_find_column", _wrap_cbf_handle_struct_find_column, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_remove_category", _wrap_cbf_handle_struct_remove_category, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_require_category", _wrap_cbf_handle_struct_require_category, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_reciprocal_cell", _wrap_cbf_handle_struct_get_reciprocal_cell, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_3d_image_size", _wrap_cbf_handle_struct_get_3d_image_size, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_find_tag_root", _wrap_cbf_handle_struct_find_tag_root, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_require_category_root", _wrap_cbf_handle_struct_require_category_root, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_integervalue", _wrap_cbf_handle_struct_set_integervalue, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_category_name", _wrap_cbf_handle_struct_category_name, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_typeofvalue", _wrap_cbf_handle_struct_get_typeofvalue, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_real_image", _wrap_cbf_handle_struct_set_real_image, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_3d_image", _wrap_cbf_handle_struct_get_3d_image, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_remove_row", _wrap_cbf_handle_struct_remove_row, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_overload", _wrap_cbf_handle_struct_set_overload, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_image_size", _wrap_cbf_handle_struct_get_image_size, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_image", _wrap_cbf_handle_struct_get_image, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_tag_root", _wrap_cbf_handle_struct_set_tag_root, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_write_widefile", _wrap_cbf_handle_struct_write_widefile, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_count_rows", _wrap_cbf_handle_struct_count_rows, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_require_datablock", _wrap_cbf_handle_struct_require_datablock, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_integerarray", _wrap_cbf_handle_struct_set_integerarray, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_new_datablock", _wrap_cbf_handle_struct_new_datablock, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_datestamp", _wrap_cbf_handle_struct_set_datestamp, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_next_row", _wrap_cbf_handle_struct_next_row, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_category_root", _wrap_cbf_handle_struct_set_category_root, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_insert_row", _wrap_cbf_handle_struct_insert_row, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_new_column", _wrap_cbf_handle_struct_new_column, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_real_3d_image", _wrap_cbf_handle_struct_get_real_3d_image, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_integration_time", _wrap_cbf_handle_struct_get_integration_time, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_realarray", _wrap_cbf_handle_struct_set_realarray, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_get_element_id", _wrap_cbf_handle_struct_get_element_id, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_value", _wrap_cbf_handle_struct_set_value, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_require_doublevalue", _wrap_cbf_handle_struct_require_doublevalue, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_rewind_datablock", _wrap_cbf_handle_struct_rewind_datablock, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_require_column_value", _wrap_cbf_handle_struct_require_column_value, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_find_datablock", _wrap_cbf_handle_struct_find_datablock, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_reset_saveframe", _wrap_cbf_handle_struct_reset_saveframe, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_doublevalue", _wrap_cbf_handle_struct_set_doublevalue, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_find_category", _wrap_cbf_handle_struct_find_category, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_find_category_root", _wrap_cbf_handle_struct_find_category_root, METH_VARARGS, NULL},
	 { (char *)"cbf_handle_struct_set_unit_cell", _wrap_cbf_handle_struct_set_unit_cell, METH_VARARGS, NULL},
...
static swig_type_info _swigt__p_cbf_detector_struct = {"_p_cbf_detector_struct", "cbf_detector_struct *|cbf_detector", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_cbf_handle_struct = {"_p_cbf_handle_struct", "cbf_handle_struct *|handle *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_cbf_positioner_struct = {"_p_cbf_positioner_struct", "cbf_positioner_struct *|cbf_goniometer", 0, 0, (void*)0, 0};
...
SWIGEXPORT void SWIG_init(void) {
  ...
  SWIG_Python_SetConstant(d, "ENC_QP",SWIG_From_int((int)(0x0004)));
  SWIG_Python_SetConstant(d, "ENC_BASE10",SWIG_From_int((int)(0x0008)));
  SWIG_Python_SetConstant(d, "ENC_BASE16",SWIG_From_int((int)(0x0010)));
  SWIG_Python_SetConstant(d, "ENC_BASE8",SWIG_From_int((int)(0x0020)));
  SWIG_Python_SetConstant(d, "ENC_FORWARD",SWIG_From_int((int)(0x0040)));
  SWIG_Python_SetConstant(d, "ENC_BACKWARD",SWIG_From_int((int)(0x0080)));
