...
static const short yyrline[] = { 0,
    87,    92,    97,   100,   105,   108,   111,   116,   121,   124,
   131,   138,   145,   152,   163,   174,   187,   198,   205,   214,
   217,   222,   227,   232,   237,   240,   243
};
#endif
...
case 10:
{
                                                  cbf_failnez (cbf_make_child (&(yyval.node), yyvsp[-1].node, CBF_CATEGORY, NULL))
